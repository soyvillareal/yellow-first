      ...
      <main className="grid min-h-full px-6 py-40 place-items-center sm:py-48 lg:px-8">
        <div className="w-3/4 text-center sm:w-1/2">
          ...
          <p className="mt-6 text-base leading-7 text-gray-400">
            Oops! It seems you've wandered into a literary void of mysteries.
            The book you seek is as elusive as a hidden chapter. Let's navigate
            back together and find literary treasures anew!
          </p>
