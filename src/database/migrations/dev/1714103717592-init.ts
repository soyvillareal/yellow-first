...
export class init1714103717592 implements MigrationInterface {
  name = 'init1714103717592';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "webhook" character varying(2000), "webhookUser" character varying(120), "webhookPassword" character varying(120), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_dedfea394088ed136ddadeee89c" UNIQUE ("name"), CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('super', 'client')`);
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(60) NOT NULL, "password" character varying(255) NOT NULL, "origin" character varying(60) NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'client', "projectName" character varying(60) NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_a39f573df258f980fd64ce2222" ON "users" ("projectName") `);
    await queryRunner.query(
      `CREATE TABLE "tokens" ("id" SERIAL NOT NULL, "userId" uuid NOT NULL, "token" text NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3001e89ada36263dabf1fb6210a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "logs" ("id" SERIAL NOT NULL, "userId" uuid, "request" jsonb NOT NULL, "response" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fb1b805f2f7795de79fa69340ba" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "webhook_logs" ("id" SERIAL NOT NULL, "logId" integer NOT NULL, "request" jsonb, "response" jsonb, "type" character varying(80) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c41f6cdf59cdfe3704807650896" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "dependencies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "projectName" character varying(80) NOT NULL, "name" character varying(80) NOT NULL, "isDefault" boolean NOT NULL DEFAULT false, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_8f53f688eef7e30b2861da194e3" UNIQUE ("name"), CONSTRAINT "PK_9f1f03f8207f8df418ae3eca645" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "forms" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "dependenceName" character varying(80) NOT NULL, "isEnabled" boolean NOT NULL DEFAULT true, "isDefault" boolean NOT NULL DEFAULT false, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ba062fd30b06814a60756f233da" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "leads" ("id" SERIAL NOT NULL, "userId" uuid NOT NULL, "name" character varying(80) NOT NULL, "surnames" character varying(80) NOT NULL, "email" character varying(255) NOT NULL, "phone_code" character varying(5) NOT NULL, "phone" character varying(25) NOT NULL, "city" character varying(80) NOT NULL, "country" character varying(80) NOT NULL, "origin" character varying(80) NOT NULL, "projectName" character varying(80) NOT NULL, "formId" uuid NOT NULL, "customValues" jsonb, "sent" boolean NOT NULL DEFAULT false, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cd102ed7a9a4ca7d4d8bfeba406" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE TYPE "public"."custom_rows_type_enum" AS ENUM('text', 'number', 'date', 'file')`);
    await queryRunner.query(
      `CREATE TABLE "custom_rows" ("id" SERIAL NOT NULL, "name" character varying(80) NOT NULL, "formId" uuid NOT NULL, "label" character varying(80) NOT NULL, "type" "public"."custom_rows_type_enum" NOT NULL, "lengthRow" integer, "nulleable" boolean DEFAULT false, "isEnabled" boolean NOT NULL DEFAULT false, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_44e67503f6928ec25522509b568" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
